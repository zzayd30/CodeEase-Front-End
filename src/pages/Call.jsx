                                ...
                                >
                                    <div className="flex flex-col gap-8">
                                        <div className="flex flex-col gap-5">
                                            <p className="text-4xl font-bold ">Have a project idea? Lets chat.</p>
                                            <p>
                                        ...
                                        <div className="flex gap-5">
                                            <div>
                                                <FaPhoneAlt className="bg-white text-[#8a8acd] text-4xl rounded-full p-2" />
                                            </div>
                                        ...
                                        <div className="flex gap-5">
                                            <div>
                                                <IoMdMail className="bg-white text-[#8a8acd] text-4xl rounded-full p-2" />
                                            </div>
                                            <div className="flex flex-col gap-2">
                                        ...
                                        <div className="flex gap-5">
                                            <div>
                                                <MdLocationPin className="bg-white text-[#8a8acd] text-4xl rounded-full p-2" />
                                            </div>
                                            <div className="flex flex-col gap-2">
